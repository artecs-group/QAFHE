...
use super::{read_models, Model, TritonContext};
use anyhow::Result;
...
impl ProxyPolicy<TritonContext> for MinQueue {
    
    async fn choose_target(&self, request: &Request<TritonContext>, endps: &Endpoints<TritonContext>) -> Uuid {
...
impl<'a> MinQueue {
    ...
    fn choose_model(&'a self, request: &Request<TritonContext>) -> &'a Model {
